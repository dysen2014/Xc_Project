...
import com.yichun.meyq.myUtils.MyRandom;
import com.yichun.meyq.myUtils.MyStringConversion;
...
//			mc.start();
//			getCode();
			et_code.setText(MyStringConversion.myInverseStrConver(MyRandom.random2Int(0, 9999)+"", 4));
			break;
